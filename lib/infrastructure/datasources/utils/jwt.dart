...
/// Utility class for JWT decoding
class JwtDecoder {
  ...
  static DateTime? _getDate({required String token, required String claim}) {
    ...
    // return DateTime.fromMillisecondsSinceEpoch(0).add(Duration(seconds: expiration));
    return DateTime.fromMillisecondsSinceEpoch(expiration * 1000, isUtc: true);
  }
